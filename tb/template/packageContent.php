...
//echo distance(32.9697, -96.80322, 29.46786, -98.53506, "N") . " Nautical Miles<br>";
    ...
    $packageInfo= "
               SELECT packageId, packageName, durationDay, durationNight, price, companyName
               FROM (package NATURAL JOIN packageowner)";
			...
			<div class="col-lg-9 col-md-8  content recP allPackage">   
                 ...
                 <div class="topP">
                    <div class="row">
						...
						<!-- link for details button: href= 'packageDetail.php?id=$packageId' -->
