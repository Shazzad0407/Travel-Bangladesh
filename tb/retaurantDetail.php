       ...
       ?>
          ...
          <div class="searchPlaces searchPackages ">
              <form method="" class="container">
                  ...
                  <input class="restaurent" type="submit" name="searchPlace" value="Search Restaurant">
              </form>
          </div>
      <!--- end div searchBar --> 
        ...
        <div class="container">
          <div class="row  middle">
              <div class="col-lg-3 col-md-4  filter hotelFilter resDetail">
                   ...
                   <div class="searchByDivision map">
                      ...
                      <div class="myMap">
                           <div id="floating-panel">
                              <input id="address" class="d-none" type="textbox" value="Green Akshay Plaza, 146/G (old), 59 (new), Satmasjid Road, Dhaka, Bangladesh">
                            </div>
                            <div id="map"></div>
              ...
              <div class="col-lg-9 col-md-8  content recP allPackage resDetailContent">   
                 
                 
                 <?php
                  include("template/restaurantDetailContentTop.php");
                  ?>
                ...
                <div class="foodMenu">
                 ...
                 <div class="topP resDetails">
                    <div class="row">
                     
                     
                     
                      <?php
                        include("template/restaurantDetailContent.php")?> 
